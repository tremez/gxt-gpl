...
public abstract class Sprite {
  ...
  protected Color stroke = Color.NONE;
  private boolean strokeDirty = true;
  protected Color fill = RGB.BLACK;
  private boolean fillDirty = true;
  ...
  private boolean zIndexDirty = true;
  ...
  public void update(Sprite sprite) {
    ...
    if (sprite.clipRectangle != null) {
      setClipRectangle(new PreciseRectangle(sprite.clipRectangle.getX(),
              sprite.clipRectangle.getY(),
              sprite.clipRectangle.getWidth(),
              sprite.clipRectangle.getHeight()));
    }
